...
allowed_route_target_ids = [
  "ocid1.natgateway.oc1.phx.xyz123",
  "ocid1.servicegateway.oc1.phx.xyz123"
]

# permitted Security List rules
allowed_ingress_rules := [
  # all
  { "protocol": "all", "cidr": "172.16.0.0/24", "src_port_min": null, "src_port_max": null, "dst_port_min": null, "dst_port_max": null, "icmp_type": null, "icmp_code": null },
  # other
  ...
  # udp
  { "protocol": "17", "cidr": "192.168.1.0/24", "src_port_min": null, "src_port_max": null, "dst_port_min": 123, "dst_port_max": 123, "icmp_type": null, "icmp_code": null },
  # tcp
  { "protocol": "6", "cidr": "192.168.1.0/24", "src_port_min": null, "src_port_max": null, "dst_port_min": 443, "dst_port_max": 443, "icmp_type": null, "icmp_code": null },
  # icmp
